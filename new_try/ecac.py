...
loan_data = pd.read_csv(csv_folder + 'loan_train' + '.csv', delimiter=';')
account_data = pd.read_csv(csv_folder + 'account' + '.csv', delimiter=';') #Prepared
card_data = pd.read_csv(csv_folder + 'card_train' + '.csv', delimiter=';') #Prepared
...
trans_data = pd.read_csv(csv_folder + 'trans_train' + '.csv', delimiter=';') #Prepared
...
new_mixed = pd.concat([pd.DataFrame(X_res), pd.DataFrame(y_res)], axis=1)
